...
nohup python -u main.py  --device cuda:2 --alpha 0.6 --dataset ${Dataset} --loss_log 2 > logs/${Dataset}_out6.log  2>&1 &
nohup python -u main.py  --device cuda:3 --alpha 0.8 --dataset ${Dataset} --loss_log 3 > logs/${Dataset}_out8.log  2>&1 &
